...
class PortfolioManagerApplicationTestNaive {
  ...
  void mainReadFile() throws Exception {
    ...
    //when
    List<String> results = PortfolioManagerApplicationNaive
  ...
  void mainReadQuotes() throws Exception {
    ...
    //when
    List<String> actual = PortfolioManagerApplicationNaive
  ...
  void mainCalculateAnnualReturn() throws Exception {
    ...
    String filename = "trades.json";
    //when
    List<AnnualizedReturn> result = PortfolioManagerApplicationNaive
  ...
  public void testCalculateAnnualizedReturn() {
    ...
    AnnualizedReturn returns = PortfolioManagerApplicationNaive
  ...
  public void testAllDebugValues() {
    List<String> responses = PortfolioManagerApplicationNaive.debugOutputs();
